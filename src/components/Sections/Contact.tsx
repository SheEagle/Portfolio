...
import resume from '@/assets/misc/Xiru Wang CV.pdf';
        ...
        <section id="contact" className="main-layout mt-20">
            <div className="flex justify-between flex-col xs:flex-row">
                <div className="flex flex-col justify-between gap-8 xs:gap-0 mb-12 xs:mb-0">
                    <a
                        href="mailto:morganwang68@gmail.com"
                    ...
                    <div>
                        <div className="text-xl font-semibold">{t('Contact.check')}</div>
                        <a
                            target="_blank"
                            href={resume}
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-1.5 2xs:gap-2">
                                ...
                                <span
                                    className="w-full h-0.5 bg-main-0 dark:bg-main-reverse-0 transition-default group-hover:bg-accent-500 group-hover:ml-4"/>
                            </div>
                        </a>

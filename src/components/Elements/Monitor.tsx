    ...
    return (
        <>
            <svg viewBox="0 0 581 476" fill="none" xmlns="http://www.w3.org/2000/svg" {...svgProps}>
                ...
                <clipPath id="screen">
                    <path
                        d="M573.212 339.464C573.212 351.908 562.575 362 549.452 362H30.6922C17.5697 362 6.93217 351.908 6.93217 339.464V30.5359C6.93217 18.0883 17.5697 8 30.6922 8H549.452C562.575 8 573.212 18.0883 573.212 30.5359V339.464Z"/>
                </clipPath>
